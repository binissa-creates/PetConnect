      ...
      <div className="w-full max-w-4xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          ...
          <div className="premium-card p-8 flex flex-col items-center text-center group">
            ...
            <Link to="/register?role=owner" className="flex items-center gap-2 text-primary font-semibold hover:gap-4 transition-all uppercase text-[10px] tracking-widest mt-auto">
              <span>Register Pet</span>
              <span className="material-symbols-outlined text-xs">arrow_forward</span>
            </Link>
            <Link to="/login?role=owner" className="text-[10px] text-on-surface-variant hover:text-primary mt-3">
